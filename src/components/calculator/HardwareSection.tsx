...
export default function HardwareSection({ onNext, onPrev }: HardwareSectionProps) {
    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Select hardware items and quantities for this deal
        </p>
      </div>
        ...
        {showAddForm && (
          <div className="space-y-4">
            <p className="text-sm text-gray-600">
              Add a custom hardware item for this calculation only. This item will not be saved for future calculations.
            </p>
      ...
      <div className="flex justify-between">
        ...
        >
          ...
          <span>Back: Deal Details</span>
        </button>
        <button 
          onClick={handleSave}
          className="btn btn-primary flex items-center space-x-2"
        >
          <span>Next: Connectivity</span>
