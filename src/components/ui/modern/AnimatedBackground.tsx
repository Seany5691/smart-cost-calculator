...
export function AnimatedBackground({ isMobile = false }: AnimatedBackgroundProps) {
  // On mobile, reduce particle count by 75% (show only 1-2 orbs instead of 5)
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      {!isMobile && (
        <>
          ...
          {/* Additional floating orbs for depth - desktop only */}
